...
extlinks = {
    'issue': ('https://github.com/crusaderky/ndcsv/issues/%s', 'GH'),
    'pull': ('https://github.com/crusaderky/ndcsv/pull/%s', 'PR'),
}
...
project = 'ndcsv'
copyright = '2018-%s, ndcsv Developers' % datetime.datetime.now().year
...
latex_documents = [
  ('index', 'ndcsv.tex', 'ndcsv Documentation',
   'ndcsv Developers', 'manual'),
]
...
man_pages = [
    ('index', 'ndcsv', 'ndcsv Documentation',
     ['ndcsv Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'ndcsv', 'ndcsv Documentation',
   'ndcsv Developers', 'ndcsv', 'N-Dimensional CSV',
   'Miscellaneous'),
]
